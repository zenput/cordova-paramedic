...
ParamedicRunner.prototype.setPermissions = function() {
    if(this.config.getPlatformId() === 'ios'){
        ...
        if(tccDb) {
            ...
            var paramediciOSPermissions = new ParamediciOSPermissions(appName, tccDb);
...
ParamedicRunner.prototype.collectDeviceLogs = function() {
    ...
    var paramedicLog = new ParamedicLog(this.config.getPlatformId(), this.tempFolder.name, outputDir);
